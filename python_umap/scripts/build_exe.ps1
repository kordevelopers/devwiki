...
The default PCCB SQL from queries/umap.sql is embedded in the executable.
To use another query, set UMAP_SQL_FILE to an absolute .sql path in .env.
No Python or package installation is required on the target PC.
