...
def save_scatter(
    ...
    controls_axis = fig.add_axes((0.04, 0.012, 0.92, 0.062), facecolor="#f8fafc")
    ...
    if show_chart and chart_data is not None:
        button_axis = fig.add_axes((0.72, 0.024, 0.20, 0.038))
...
def _register_click_handler(
    ...
    input_axis = fig.add_axes((0.10, 0.024, 0.31, 0.038))
    ...
    search_axis = fig.add_axes((0.43, 0.024, 0.12, 0.038))
