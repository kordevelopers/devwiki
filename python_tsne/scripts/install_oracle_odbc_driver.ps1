...
if (-not (Test-Path -LiteralPath $installer)) {
    throw "odbc_install.exe was not found in '$resolved'. Extract Oracle Instant Client Basic/Basic Lite and ODBC ZIP files into the same folder first."
}

Write-Host "Installing the Oracle ODBC driver from $resolved"
