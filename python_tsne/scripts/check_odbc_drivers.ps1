...
if (-not $oracleDrivers) {
    Write-Warning "No Oracle ODBC driver was found. Install Oracle Instant Client Basic/Basic Lite plus the ODBC package, then run odbc_install.exe as Administrator."
    exit 1
}
